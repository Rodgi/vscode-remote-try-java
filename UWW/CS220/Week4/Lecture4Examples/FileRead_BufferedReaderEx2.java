...
public class FileRead_BufferedReaderEx2 {
	public static void main(String[] args) throws IOException {
		...
		String filename = "/workspaces/vscode-remote-try-java/UWW/CS220/Week4/Lecture4Examples/files/myfile3.csv";
		// note
		// csv
		// file
		// is
		...
		// BufferedReader br = new BufferedReader(new FileReader(file)); //use File
		// object
		 ...
		 * The solution: an assignment expression in Java (i.e. someVariable =
		 * someExpression) returns the value of the expression
		 * So, the expression (a = b) will return the value of a AFTER the assignment is
		 * performed
